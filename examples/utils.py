...
def compute_amce_ppi(n_data, N_data, x, y, alpha=0.05):
    ...
    def CalcTheoreticalInt(r):
        ...
        if r["Intervention"] == 0:
            if r["Barrier"] == 0:
                ...
                if r["CrossingSignal"] == 0:
                    p = p * 0.48
                elif r["CrossingSignal"] == 1:
                    p = p * 0.2
                else:
                    p = p * 0.32
            else:
    ...
    if x == "Barrier":
        ...
        n_data_sub = n_data.loc[
            (n_data["CrossingSignal"] == 0) & (n_data["PedPed"] == 0), :
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["CrossingSignal"] == 0) & (N_data["PedPed"] == 0), :
        ].copy()
    ...
    if x == "CrossingSignal":
        ...
        n_data_sub = n_data.loc[
            (n_data["CrossingSignal"] != 0) & (n_data["PedPed"] == 1), :
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["CrossingSignal"] != 0) & (N_data["PedPed"] == 1), :
        ].copy()
    ...
    if x == "Utilitarian":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Utilitarian")
            & (n_data["ScenarioTypeStrict"] == "Utilitarian"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Utilitarian")
    ...
    if x == "Species":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Species")
            & (n_data["ScenarioTypeStrict"] == "Species"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Species")
    ...
    if x == "Gender":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Gender")
            & (n_data["ScenarioTypeStrict"] == "Gender"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Gender")
    ...
    if x == "Fitness":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Fitness")
            & (n_data["ScenarioTypeStrict"] == "Fitness"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Fitness")
    ...
    if x == "Age":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Age")
            & (n_data["ScenarioTypeStrict"] == "Age"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Age")
    ...
    if x == "Social Status":
        ...
        n_data_sub = n_data.loc[
            (n_data["ScenarioType"] == "Social Status")
            & (n_data["ScenarioTypeStrict"] == "Social Status"),
            :,
        ].copy()
        N_data_sub = N_data.loc[
            (N_data["ScenarioType"] == "Social Status")
    ...
    pointest_ppi = ppi_ols_pointestimate(
        X=n_X,
        Y=n_Y_human,
        Yhat=n_Y_silicon,
        X_unlabeled=N_X,
    ...
    lower_CI_ppi, upper_CI_ppi = ppi_ols_ci(
        X=n_X,
        Y=n_Y_human,
        Yhat=n_Y_silicon,
        X_unlabeled=N_X,
    ...
    lower_CI_ols, upper_CI_ols = classical_ols_ci(
        X=n_X, Y=n_Y_human, w=n_weights, alpha=alpha
    )
    ...
    output_df = pd.DataFrame(
        {
            ...
            "conf_low_ppi": lower_CI_ppi[
                1
            ],  # The lower bound of the PPI confidence interval
            "conf_high_ppi": upper_CI_ppi[
                1
            ],  # The upper bound of the PPI confidence interval
            "conf_low_ols": lower_CI_ols[
                1
            ],  # The lower bound of the OLS confidence interval
            "conf_high_ols": upper_CI_ols[
                1
            ],  # The upper bound of the OLS confidence interval
        },
        index=[0],
    )
