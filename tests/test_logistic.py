...
def test_logistic_pointestimate_debias():
...
def test_logistic_pointestimate_recovers():
    # Make a synthetic regression problem
    n = 10000
    N = 100000
    d = 3
...
def logistic_ci_subtest(i, alphas, n=1000, N=10000, d=1, epsilon=0.02):
...
def test_logistic_ci_parallel():
    ...
    with ProcessPoolExecutor() as executor:
        futures = [executor.submit(logistic_ci_subtest, i, alphas, n, N, d, epsilon) for i in range(num_trials)]
